...
// schema) - same cross-schema pattern as kanban's notify.go and every
// module's audit.go: a direct fully-qualified INSERT, no HTTP call and no
// shared Go library between modules. Best-effort: a failure here never
