...
// people already invited (or the event owner) from the suggestions.
// NOTE: unlike the other frontends' copy of this component, chat's own
// /users endpoint returns `id` (not `userId`) - see backend/models.go's
// UserRef - so this copy is keyed off `id` instead.
